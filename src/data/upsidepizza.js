const place = {
  upsidepizza: {
    ...
    text: [
      ...
      "Inside was a super old school tiled pizzeria decor. The staff working there was super nice and was happy to introduce their favorite slices (mushroom!) and their signature sourdough bread. I opted in for the pepperoni corner slice, and they popped it into the oven to heat up.",
      "I took the pizza to go and was excited to dive into it once I got back. My first impression was that the slice was ginormous up close, not only in length and width but also in height.",
      "When I took a bite, I was first hit by the saltiness and char of the peps. There was a thick layer of cheese but was unfortunately not melted and a bit chewy. My favorite part of the slice was the bread. It was fluffy like a focaccia with a slight char on the bottom, giving the pizza a crunch in every bite. The sourdough was subtle, and the acidity was welcome in cutting through the saltiness of the pizza. I was surprised that pizza was not as greasy as I expected, and the bread played a big role in making the slice light.",
