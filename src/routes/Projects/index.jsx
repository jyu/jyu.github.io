      ...
      <div className={!isMobile ? classes.container : classes.containerMobile}>
        ...
        <div className={classes.projects}>
          <a
            ...
            target="_blank"
          >
            <img className={classes.projectImage} src={cookiebot} />
            <div className={classes.projectName}>Cookiebot</div>
            <div className={classes.flow}>ML based gesture controlled home robot</div>
          ...
          <a
            ...
            target="_blank"
          >
            <img className={classes.projectImage} src={localization} />
          ...
          <a
            className={`${classes.project} text-link`}
            href={process.env.PUBLIC_URL + "/multi_card_recognition_report.pdf"}
            target="_blank"
          >
            <img className={classes.projectImage} src={cards} />
            <div className={classes.projectName}>Multi Card Recognition</div>
            <div className={classes.flow}>Using autogenerated data, autoencoders, CNNs</div>
            <div className={classes.flow}>Fall 2019</div>
          </a>
          <a className={`${classes.project} text-link`} href="https://gocaltra.herokuapp.com/dashboard" target="_blank">
            <img className={classes.projectImage} src={caltra} />
            <div className={classes.projectName}>Caltra</div>
            <div className={classes.flow}>Helping over 3,500 people reach their goals</div>
            <div className={classes.flow}>Summer 2019</div>
          </a>
          <a className={`${classes.project} text-link`} href="/nlp-qa" target="_blank">
            <img className={classes.projectImage} src={nlp} />
          ...
          <a className={`${classes.project} text-link`} href="/tldw" target="_blank">
            <img className={classes.projectImage} src={tldw} />
          ...
          <a className={`${classes.project} text-link`} href="/fudmaps" target="_blank">
            <img className={classes.projectImage} src={fudmaps} />
          ...
          <a className={`${classes.project} text-link`} href="/portrait-mode/" target="_blank">
            <img className={classes.projectImage} src={portrait} />
          ...
          <a className={`${classes.project} text-link`} href="/spotrecs/" target="_blank">
            <img className={classes.projectImage} src={spotrecs} />
